...
if !exists('g:close_buffers_bdelete_command')
  let g:close_buffers_bdelete_command = 'BufDelete'
endif

if !exists('g:close_buffers_bwipeout_command')
  let g:close_buffers_bwipeout_command = 'BufWipeout'
endif
...
if !exists(':CloseAllBuffers')
  command -bang CloseAllBuffers echoerr '":CloseAllBuffers" is obsolete. Use ":BufDelete all" instead.'
endif

if !exists(':CloseHiddenBuffers')
  command -bang CloseHiddenBuffers echoerr '":CloseHiddenBuffers" is obsolete. Use ":BufDelete hidden" instead.'
endif

if !exists(':CloseNamelessBuffers')
  command -bang CloseNamelessBuffers echoerr '":CloseNamelessBuffers" is obsolete. Use ":BufDelete nameless" instead.'
endif

if !exists(':CloseOtherBuffers')
  command -bang CloseOtherBuffers echoerr '":CloseOtherBuffers" is obsolete. Use ":BufDelete other" instead.'
endif

if !exists(':CloseSelectedBuffers')
  command -bang CloseSelectedBuffers echoerr '":CloseSelectedBuffers" is obsolete. Use ":BufDelete select" instead.'
endif

if !exists(':CloseThisBuffer')
  command -bang CloseThisBuffer echoerr '":CloseThisBuffer" is obsolete. Use ":BufDelete this" instead.'
endif

if !exists(':CloseBuffers')
  command -bang CloseBuffers echoerr '":CloseBuffers" is obsolete. Use ":BufDelete menu" instead.'
endif

if !exists(':CloseBuffersMenu')
  command -bang CloseBuffersMenu echoerr '":CloseBuffersMenu" is obsolete. Use ":BufDelete menu" instead.'
endif
